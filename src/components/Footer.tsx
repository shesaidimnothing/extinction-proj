    ...
    <footer className="bg-primary text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-white opacity-90">
              ...
              <p className="mb-4">Email: contact@rentokil.fr</p>
        ...
        <div className="border-t border-white border-opacity-20 mt-12 pt-8 text-center text-white text-sm opacity-90">
          <p>&copy; {new Date().getFullYear()} Rentokil. Tous droits réservés.</p>
...
const SocialIcon = ({ href, icon }: { href: string; icon: string }) => {
  return (
    <motion.a 
      ...
      whileTap={{ scale: 0.9 }}
      className="w-8 h-8 rounded-full bg-white text-primary flex items-center justify-center"
    >
